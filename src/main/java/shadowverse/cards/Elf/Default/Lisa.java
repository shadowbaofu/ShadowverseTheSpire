...
public class Lisa extends CustomCard {
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        addToBot(new SFXAction("Lisa"));
        addToBot(new ApplyPowerAction(abstractPlayer, abstractPlayer, new ArtifactPower(abstractPlayer, this.magicNumber), this.magicNumber));
    }
