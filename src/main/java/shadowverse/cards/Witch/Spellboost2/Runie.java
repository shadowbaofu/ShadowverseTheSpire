...
import shadowverse.cards.Neutral.Temp.ProphecyOfDoom;
import shadowverse.cards.Neutral.Temp.ProphecyOfBoons;
...
public class Runie extends CustomCard implements BranchableUpgradeCard {
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        switch (chosenBranch()) {
            case 0:
                addToBot(new SFXAction("Runie"));
                addToBot(new RunieAction(this.magicNumber, this));
                this.baseMagicNumber = 0;
                this.magicNumber = this.baseMagicNumber;
                break;
            case 1:
                //增幅
                addToBot(new SFXAction("Runie2"));
                ...
                AbstractCard boons = new ProphecyOfBoons();
                AbstractCard doom = new ProphecyOfDoom();
                addToBot(new ChoiceAction2(boons, doom));
                break;
            default:
                break;
        }
