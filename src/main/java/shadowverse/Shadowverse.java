...
public class Shadowverse implements PostInitializeSubscriber, EditCardsSubscriber, EditStringsSubscriber, EditKeywordsSubscriber, EditCharactersSubscriber, EditRelicsSubscriber {
    ...
    public void receivePostInitialize() {
        ...
        if (!Loader.isModLoaded("ShadowverseTheSpireEnglishVoicePack")) {
            ...
            reflectedMap.put("SoaringSpirit", new Sfx(voicePath + "SoaringSpirit.wav"));
            reflectedMap.put("SkySpirit", new Sfx(voicePath + "SkySpirit.wav"));
            reflectedMap.put("SaplingSteward_L", new Sfx(voicePath + "SaplingSteward_L.wav"));
            reflectedMap.put("SaplingSteward", new Sfx(voicePath + "SaplingSteward.wav"));
            reflectedMap.put("FrostbornPrincess", new Sfx(voicePath + "FrostbornPrincess.wav"));
            reflectedMap.put("UndyingWitch", new Sfx(voicePath + "UndyingWitch.wav"));
            reflectedMap.put("SeekerOfTruths", new Sfx(voicePath + "SeekerOfTruths.wav"));
            reflectedMap.put("ScornerOfTruths", new Sfx(voicePath + "ScornerOfTruths.wav"));
            reflectedMap.put("GraveAdjudicatorPower", new Sfx(voicePath + "GraveAdjudicatorPower.wav"));
            reflectedMap.put("GraveAdjudicator", new Sfx(voicePath + "GraveAdjudicator.wav"));
            reflectedMap.put("GallantDragonewt", new Sfx(voicePath + "GallantDragonewt.wav"));
            reflectedMap.put("TanzaniteConvictorPower2", new Sfx(voicePath + "TanzaniteConvictorPower2.wav"));
            reflectedMap.put("TanzaniteConvictorPower1", new Sfx(voicePath + "TanzaniteConvictorPower1.wav"));
            reflectedMap.put("TanzaniteConvictor", new Sfx(voicePath + "TanzaniteConvictor.wav"));
            reflectedMap.put("SyntheticEden", new Sfx(voicePath + "SyntheticEden.wav"));
            reflectedMap.put("SeraphsOfTheTrueKey", new Sfx(voicePath + "SeraphsOfTheTrueKey.wav"));
            reflectedMap.put("PurelightPrototype", new Sfx(voicePath + "PurelightPrototype.wav"));
            reflectedMap.put("PurelightExemplar", new Sfx(voicePath + "PurelightExemplar.wav"));
            reflectedMap.put("Hunters_Eff", new Sfx(voicePath + "Hunters_Eff.wav"));
            reflectedMap.put("Hunters", new Sfx(voicePath + "Hunters.wav"));
            reflectedMap.put("GoddessOfCondemnation", new Sfx(voicePath + "GoddessOfCondemnation.wav"));
            reflectedMap.put("GoddessOfCompassion", new Sfx(voicePath + "GoddessOfCompassion.wav"));
            ...
            reflectedMap.put("Elena", new Sfx(voicePath + "Elena.wav"));
            reflectedMap.put("BrotherUnited2", new Sfx(voicePath + "BrotherUnited2.wav"));
            reflectedMap.put("HasteningConviction", new Sfx(voicePath + "HasteningConviction.wav"));
            reflectedMap.put("Maiser2", new Sfx(voicePath + "Maiser2.wav"));
            reflectedMap.put("FriendsForever2", new Sfx(voicePath + "FriendsForever2.wav"));
            reflectedMap.put("HollowGovernance", new Sfx(voicePath + "HollowGovernance.wav"));
            reflectedMap.put("Briarmaiden", new Sfx(voicePath + "Briarmaiden.wav"));
            reflectedMap.put("BriarmaidenPower", new Sfx(voicePath + "BriarmaidenPower.wav"));
            reflectedMap.put("ForbiddenPower", new Sfx(voicePath + "ForbiddenPower.wav"));
            reflectedMap.put("Nicola4", new Sfx(voicePath + "Nicola4.wav"));
            reflectedMap.put("Aenea2", new Sfx(voicePath + "Aenea2.wav"));
            reflectedMap.put("ManmaruRe", new Sfx(voicePath + "ManmaruRe.wav"));
            reflectedMap.put("JoySecured", new Sfx(voicePath + "JoySecured.wav"));
            reflectedMap.put("GarnetRelease", new Sfx(voicePath + "GarnetRelease.wav"));
            reflectedMap.put("Mono3", new Sfx(voicePath + "Mono3.wav"));
            reflectedMap.put("Mono3_A", new Sfx(voicePath + "Mono3_A.wav"));
            reflectedMap.put("CursedFuror2", new Sfx(voicePath + "CursedFuror2.wav"));
            reflectedMap.put("CrystalshardDragonewt", new Sfx(voicePath + "CrystalshardDragonewt.wav"));
            reflectedMap.put("CrystalshardDragonewtPower", new Sfx(voicePath + "CrystalshardDragonewtPower.wav"));
            reflectedMap.put("ShadowRejection", new Sfx(voicePath + "ShadowRejection.wav"));
            reflectedMap.put("Valdain3", new Sfx(voicePath + "Valdain3.wav"));
            reflectedMap.put("NewfoundAllies2", new Sfx(voicePath + "NewfoundAllies2.wav"));
            reflectedMap.put("YuwanFervor", new Sfx(voicePath + "YuwanFervor.wav"));
            reflectedMap.put("BelphometAuthority", new Sfx(voicePath + "BelphometAuthority.wav"));
            reflectedMap.put("RevolutionShot", new Sfx(voicePath + "RevolutionShot.wav"));
            reflectedMap.put("Spector2", new Sfx(voicePath + "Spector2.wav"));
            reflectedMap.put("SorceryInSolidarity2", new Sfx(voicePath + "SorceryInSolidarity2.wav"));
            reflectedMap.put("Tetra4", new Sfx(voicePath + "Tetra4.wav"));
            reflectedMap.put("Tetra4Power", new Sfx(voicePath + "Tetra4Power.wav"));
            reflectedMap.put("AzureBlast", new Sfx(voicePath + "AzureBlast.wav"));
            reflectedMap.put("Lubelle2", new Sfx(voicePath + "Lubelle2.wav"));
            reflectedMap.put("Atem", new Sfx(voicePath + "Atem.wav"));
            reflectedMap.put("SuccessionOfBalance", new Sfx(voicePath + "SuccessionOfBalance.wav"));
            reflectedMap.put("FieryReproach", new Sfx(voicePath + "FieryReproach.wav"));
            reflectedMap.put("Selena2", new Sfx(voicePath + "Selena2.wav"));
            reflectedMap.put("Ladica3", new Sfx(voicePath + "Ladica3.wav"));
            reflectedMap.put("Ladica3_Eff", new Sfx(voicePath + "Ladica3_Eff.wav"));
            reflectedMap.put("BackToNature", new Sfx(voicePath + "BackToNature.wav"));
            reflectedMap.put("GarnetWaltz2", new Sfx(voicePath + "GarnetWaltz2.wav"));
            reflectedMap.put("SigilOfBalance", new Sfx(voicePath + "SigilOfBalance.wav"));
            reflectedMap.put("Marlone3", new Sfx(voicePath + "Marlone3.wav"));
            reflectedMap.put("Meowskers", new Sfx(voicePath + "Meowskers.wav"));
            reflectedMap.put("Meowskers_Acc", new Sfx(voicePath + "Meowskers_Acc.wav"));
            reflectedMap.put("MajorPrayers2", new Sfx(voicePath + "MajorPrayers2.wav"));
            reflectedMap.put("Rola2", new Sfx(voicePath + "Rola2.wav"));
            reflectedMap.put("RosyCourtMagician", new Sfx(voicePath + "RosyCourtMagician.wav"));
            reflectedMap.put("NeoTisiphone2", new Sfx(voicePath + "NeoTisiphone2.wav"));
            reflectedMap.put("NeoAlector2", new Sfx(voicePath + "NeoAlector2.wav"));
            reflectedMap.put("NeoMegaera2", new Sfx(voicePath + "NeoMegaera2.wav"));
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new DelugeOfArrows());
        BaseMod.addCard(new RainOfArrows());
        BaseMod.addCard(new FrostbornPrincess());
        BaseMod.addCard(new SaplingSteward());
        BaseMod.addCard(new SkySpirit());
        BaseMod.addCard(new SoaringSpirit());
        BaseMod.addCard(new Checkmate());
        BaseMod.addCard(new Battery());
        BaseMod.addCard(new ScornerOfTruths());
        BaseMod.addCard(new SeekerOfTruths());
        BaseMod.addCard(new UndyingWitch());
        BaseMod.addCard(new GallantDragonewt());
        BaseMod.addCard(new GraveAdjudicator());
        BaseMod.addCard(new GraveVoidknight());
        BaseMod.addCard(new HeartRadiance());
        BaseMod.addCard(new SoulLight());
        BaseMod.addCard(new HowToTrainYourWolf());
        BaseMod.addCard(new HowToTrainYourBat());
        BaseMod.addCard(new Companions());
        BaseMod.addCard(new Hunters());
        BaseMod.addCard(new TanzaniteConvictor());
        BaseMod.addCard(new SeraphsOfTheTrueKey());
        BaseMod.addCard(new AngelsOfTheCovenant());
        BaseMod.addCard(new PurelightExemplar());
        BaseMod.addCard(new PurelightPrototype());
        BaseMod.addCard(new DisseminatorOfWisdom());
        BaseMod.addCard(new SyntheticEden());
        BaseMod.addCard(new BlazingBarrage());
        ...
        BaseMod.addCard(new HasteningConviction());
        BaseMod.addCard(new Elena());
        BaseMod.addCard(new OvergrownWretch());
        BaseMod.addCard(new HollowGovernance());
        BaseMod.addCard(new Briarmaiden());
        ...
        BaseMod.addCard(new SanctumOfWings());
        BaseMod.addCard(new YuwanFervor());
        BaseMod.addCard(new BelphometAuthority());
        BaseMod.addCard(new RevolutionShot());
        BaseMod.addCard(new V2());
        BaseMod.addCard(new FullMetalZombie());
        BaseMod.addCard(new Atem());
        BaseMod.addCard(new SuccessionOfBalance());
        BaseMod.addCard(new FieryReproach());
        BaseMod.addCard(new BackToNature());
        BaseMod.addCard(new SigilOfBalance());
        BaseMod.addCard(new Meowskers());
        BaseMod.addCard(new RosyCourtMagician());
        BaseMod.addCard(new NeoTisiphone2());
