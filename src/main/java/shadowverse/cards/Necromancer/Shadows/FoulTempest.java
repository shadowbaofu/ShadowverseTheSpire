...
import shadowverse.characters.Necromancer;
 ...
 public class FoulTempest extends CustomCard {
   ...
   public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
     ...
     addToBot(new NecromanceAction(6,
             new DamageAllEnemiesAction((AbstractCreature)abstractPlayer, DamageInfo.createDamageMatrix(this.damage, true), DamageInfo.DamageType.THORNS, AbstractGameAction.AttackEffect.NONE, true),
             new DamageAllEnemiesAction((AbstractCreature)abstractPlayer, DamageInfo.createDamageMatrix(this.damage*3, true), DamageInfo.DamageType.THORNS, AbstractGameAction.AttackEffect.NONE, true)
             ));
   }
