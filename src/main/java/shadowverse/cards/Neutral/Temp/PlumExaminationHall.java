...
public class PlumExaminationHall extends AbstractAmuletCard {
    public static final String ID = "shadowverse:PlumExaminationHall";
    public static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("shadowverse:PlumExaminationHall");
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "img/cards/PlumExaminationHall.png";

    public PlumExaminationHall() {
    ...
    public void onChoseThisOption() {
        addToBot(new SFXAction("PlumExaminationHall"));
        addToBot(new HealAction(AbstractDungeon.player,AbstractDungeon.player,this.magicNumber));
